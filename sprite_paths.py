...
class UISpritePaths:
    ...
    menu_bar = ui_path + "menu_bar.png"

    player_left = ui_path + "player_hand_pointers/player_left.png"
    player_right = ui_path + "player_hand_pointers/player_right.png"

    computer_left = ui_path + "computer_hand_pointers/computer_left.png"
    computer_right = ui_path + "computer_hand_pointers/computer_right.png"