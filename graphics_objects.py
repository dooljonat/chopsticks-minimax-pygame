...
from settings import BoardInfo
...
class ComputerLeftHandSprite:
    ...
    def draw(self, screen, game):
        ...
        hand_count = game.current_board[BoardInfo.COMPUTER_LEFT_HAND]
...
class ComputerRightHandSprite:
    ...
    def draw(self, screen, game):
        ...
        hand_count = game.current_board[BoardInfo.COMPUTER_RIGHT_HAND]
...
class PlayerLeftHandSprite():
    ...
    def draw(self, screen, game):
        ...
        # Get current count of computer's right hand in-game
        hand_count = game.current_board[BoardInfo.PLAYER_LEFT_HAND]
...
class PlayerRightHandSprite:
    ...
    def draw(self, screen, game):
        ...
        # Get current count of computer's right hand in-game
        hand_count = game.current_board[BoardInfo.PLAYER_RIGHT_HAND]
